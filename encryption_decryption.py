...
def startEncryption():
    ...
    btn_create = Button(encryption_window, text="Create", font = 'arial 13',command=SaveData,bg="darkorange",fg="#3b060d")
...
btn_start_encryption = Button(root, text="Start Encryption" , font = 'arial 13' , command=startEncryption,bg="darkorange",fg="#3b060d")
btn_start_encryption.place(relx=0.3,rely=0.6, anchor=CENTER)

btn_start_decryption = Button(root, text="Start Decryption" , font = 'arial 13' ,  command=startDecryption,bg="darkorange",fg="#3b060d")
